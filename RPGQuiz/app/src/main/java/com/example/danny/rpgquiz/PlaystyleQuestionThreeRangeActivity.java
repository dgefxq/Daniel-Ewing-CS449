...
public class PlaystyleQuestionThreeRangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playstyle_question_three_range);
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(PlaystyleQuestionThreeRangeActivity.this, PriestActivity.class);
        ...
        neutralButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(PlaystyleQuestionThreeRangeActivity.this, PlaystyleRangeHealingDamageBreakActivity.class);
                startActivity(myIntent);
            }
        });
        disagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(PlaystyleQuestionThreeRangeActivity.this, MageActivity.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // needs overwritten with an activity for displaying information about the application.
        switch (item.getItemId()){
            case R.id.about_menu_item:{
                Intent myIntent = new Intent( PlaystyleQuestionThreeRangeActivity.this,
                        AboutActivity.class);
                startActivity(myIntent);
                return true;
            }
