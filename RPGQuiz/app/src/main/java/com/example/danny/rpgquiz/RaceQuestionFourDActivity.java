...
public class RaceQuestionFourDActivity extends AppCompatActivity {
    private Button stronglyAgreeButton, agreeButton,  disagreeButton, stronglyDisagreeButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_race_question_four_d);
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionFourDActivity.this, MinotaurActivity.class);
        ...
        disagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionFourDActivity.this, HarpyActivity.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // needs overwritten with an activity for displaying information about the application.
        switch (item.getItemId()){
            case R.id.about_menu_item:{
                Intent myIntent = new Intent( RaceQuestionFourDActivity.this,
                        AboutActivity.class);
                startActivity(myIntent);
                return true;
            }
