...
public class RaceQuestionThreeC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionThreeC.this, RaceQuestionFourCActivity.class);
        ...
        disagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionThreeC.this, HumanActivity.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // needs overwritten with an activity for displaying information about the application.
        switch (item.getItemId()){
            case R.id.about_menu_item:{
                Intent myIntent = new Intent( RaceQuestionThreeC.this,
                        AboutActivity.class);
                startActivity(myIntent);
                return true;
            }
