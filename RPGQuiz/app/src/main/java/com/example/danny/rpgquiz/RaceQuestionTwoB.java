...
public class RaceQuestionTwoB extends AppCompatActivity {
    private Button stronglyAgreeButton, agreeButton, disagreeButton, stronglyDisagreeButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_race_question_two_b);
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionTwoB.this, RaceQuestionThreeC.class);
        ...
        disagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(RaceQuestionTwoB.this, RaceQuestionThreeD.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // needs overwritten with an activity for displaying information about the application.
        switch (item.getItemId()){
            case R.id.about_menu_item:{
                Intent myIntent = new Intent( RaceQuestionTwoB.this,
                        AboutActivity.class);
                startActivity(myIntent);
                return true;
            }
