...
public class PlaystyleQuestionTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playstyle_question_two);
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(PlaystyleQuestionTwoActivity.this, MageActivity.class);
        ...
        agreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(PlaystyleQuestionTwoActivity.this, PlaystyleQuestionThreeActivity.class);
                startActivity(myIntent);
            }
        });
