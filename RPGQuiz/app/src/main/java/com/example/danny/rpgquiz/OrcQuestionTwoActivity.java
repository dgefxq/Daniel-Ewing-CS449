    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stronglyAgreeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(OrcQuestionTwoActivity.this, RaceOrcBreakActivity.class);
        ...
        agreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(OrcQuestionTwoActivity.this, OrcQuestionThreeActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        disagreeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(OrcQuestionTwoActivity.this, ElfQuestionOneActivity.class);
                startActivity(myIntent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // needs overwritten with an activity for displaying information about the application.
        switch (item.getItemId()){
            case R.id.about_menu_item:{
                Intent myIntent = new Intent( OrcQuestionTwoActivity.this,
                        AboutActivity.class);
                startActivity(myIntent);
                return true;
            }
